...
namespace MissileLaunchArcHud_Engine
{
    internal sealed class LaunchArcCircleView
    {
        ...
        internal void Apply(LaunchArcGameApi.LaunchArcSnapshot snap, Transform hudCenterAnchor)
        {
            ...
            bool useFullRing = !MissileLaunchArcHudPlugin.PartialRing.Value
                || snap.CircleScale < MissileLaunchArcHudPlugin.FullRingBelowScale.Value;
            ...
            if (MissileLaunchArcHudPlugin.DrawBehindHud.Value)

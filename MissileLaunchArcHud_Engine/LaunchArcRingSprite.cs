...
namespace MissileLaunchArcHud_Engine
{
    internal static class LaunchArcRingSprite
    {
        ...
        private static int ComputeCacheKey()
        {
            ...
            {
                int h = 17;
                h = h * 31 + MissileLaunchArcHudPlugin.RingInnerRadius01.Value.GetHashCode();
                h = h * 31 + MissileLaunchArcHudPlugin.RingOuterRadius01.Value.GetHashCode();
                h = h * 31 + MissileLaunchArcHudPlugin.PartialSideArcDegrees.Value.GetHashCode();
                return h;
            }
        }
        ...
        private static Sprite BuildRing(bool fullCircle)
        {
            ...
            float inner01 = Mathf.Clamp(MissileLaunchArcHudPlugin.RingInnerRadius01.Value, 0.5f, 0.99f);
            float outer01 = Mathf.Clamp(MissileLaunchArcHudPlugin.RingOuterRadius01.Value, inner01 + 0.002f, 0.995f);

...
namespace MissileLaunchArcHud_Engine
{
    ...
    internal static class LaunchArcGameApi
    {
        ...
        internal static bool TryGetSnapshot(out LaunchArcSnapshot snapshot)
        {
            ...
            if (!MissileLaunchArcHudPlugin.Enabled.Value)
                return false;
            ...
            if (info.laserGuided && MissileLaunchArcHudPlugin.HideForLaserGuided.Value)
                return false;
            ...
            if (MissileLaunchArcHudPlugin.RequireTargetLock.Value && !anyKnown)
                return false;
            ...
            if (MissileLaunchArcHudPlugin.NezMarkersEnabled.Value && IsNezMeaningful())
            ...
            Dictionary<int, float> holdUntilByUnitId)
        {
            ...
            float holdSec = Mathf.Max(0.05f, MissileLaunchArcHudPlugin.TargetRingInsideArcHoldSeconds.Value);
        ...
        private static LaunchArcNezPhase EvaluateNezPhase(float targetDist)
        {
            ...
            float band = Mathf.Max(100f, MissileLaunchArcHudPlugin.NezApproachBandMeters.Value);
        ...
        internal static float ComputeCircleScale(float cameraFov, float arcDegrees)
        {
            ...
            float radiusFix = Mathf.Max(1f, MissileLaunchArcHudPlugin.ArcRadiusScale.Value);
